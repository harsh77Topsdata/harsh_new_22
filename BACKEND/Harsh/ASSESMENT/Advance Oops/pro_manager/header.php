    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Play Dynamics</a>
            </div>
                ...
                <ul class="nav" id="main-menu">
                    <li>
                        <div class="user-img-div">
                            <img src="assets/img/roman.jpg" class="img-thumbnail" />
					...
					<li>
                        <a  href="index"><i class="fa fa-dashboard "></i>index</a>
                    </li>
					...
					<li>
                        <a  href="manage_cust"><i class="fa fa-square-o "></i>manage customer</a>
                    </li>
