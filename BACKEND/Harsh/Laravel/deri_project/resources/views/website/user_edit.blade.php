...
@section('main_contant')
                        ...
                        <form method="post" action="{{url('/update_user/' . $data->id)}}" name="sentMessage" id="contactForm"
                            ...
                            <div class="form-row">
                                <div class="col-sm-12 control-group">
                                    <input type="text" name="name" value="{{$data->name}}" class="form-control p-4"
                            ...
                            <div class="form-row">
                                <div class="col-sm-12 control-group">
                                    <input type="email" name="email" value="{{$data->email}}" class="form-control p-4"
    ...
    $lag_arr = explode(",", $lag);
                                ...
                                Lag :<br>
                                Hindi :<input type="checkbox" name="lag[]" <?php if (in_array("Hindi", $lag_arr)) {
        echo "checked";
    }?> value="Hindi" class="p-4" />
                                English<input type="checkbox" name="lag[]" <?php if (in_array("English", $lag_arr)) {
        echo "checked";
    }?> value="English" class="p-4" />
                                Gujarati<input type="checkbox" name="lag[]" <?php if (in_array("Gujarati", $lag_arr)) {
        echo "checked";
    }?> value="Gujarati" class="p-4" />
                                <br> <br>
                            </div>
                            <div class="form-row">
                                <div class="col-sm-12 control-group">
                                    <input type="file" name="img" class="form-control p-4" id="email"
                                        placeholder="Your Image" />
                                    <img src="{{ url('website/upload/users/' . $data->img)}}"
